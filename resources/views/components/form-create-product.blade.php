<form class="flex flex-col gap-y-4 justify-center w-3/4 mx-auto" action="" method=""
    ...
    <div class="flex flex-col">
        <label for="availableStock">Product Stock Available</label>
    ...
    <div class="flex flex-col">
        ...
        <select name="productId">
            @foreach ($categories as $category)
                <option value="Ada">{{ $category->name }}</option>
            @endforeach
        </select>
    </div>
    <div class="flex flex-col">
